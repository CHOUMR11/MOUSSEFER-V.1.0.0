...
public class PaymentService {
     ...
     * Le montant et la devise sont déterminés côté serveur (prix réel de la réservation).
     * Le client ne peut pas les influencer.
     */
    @Transactional
    public PaymentResponse initiatePayment(InitiatePaymentRequest request, String passengerId) {
        ...
        // Récupération du prix réel et du statut depuis reservation-service
        ...
        // Devise Dinar Tunisien (réglementation Ministère du Transport)
        String currency = "TND";
        ...
        BigDecimal commission = finalAmount.multiply(commissionRate).setScale(2, RoundingMode.HALF_EVEN);
        ...
        // Transition de la réservation vers PAYMENT_PENDING (non bloquante)
        try {
            ...
            // Non bloquant : le webhook Stripe finira par confirmer le paiement
        }
    ...
    public org.springframework.http.ResponseEntity<byte[]> getInvoicePdf(String reservationId, String userId) {
        ...
        // Redirection vers l'URL MinIO (non signée – à améliorer en production)
    ...
    public java.util.Map<String, Object> getCommissionReport(String fromDate, String toDate) {
        ...
        return java.util.Map.of(
                ...
                "commissionRate", commissionRate.multiply(BigDecimal.valueOf(100)) + "%"
        );
    }
