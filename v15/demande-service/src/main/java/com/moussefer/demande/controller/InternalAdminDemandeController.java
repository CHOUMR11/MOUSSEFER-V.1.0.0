...
public class InternalAdminDemandeController {
    ...
    // Constructeur explicite (au cas où Lombok ne fonctionne pas)
    public InternalAdminDemandeController(DemandeMergeService mergeService, DemandeService demandeService) {
