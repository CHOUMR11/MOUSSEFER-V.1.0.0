 ...
 * delegates to banner-service's internal admin endpoints.
 */
@RestController
@RequestMapping("/api/v1/admin/banners")
@RequiredArgsConstructor
@Tag(name = "Admin – Banners", description = "Frontend-facing proxy to banner-service internal admin endpoints")
