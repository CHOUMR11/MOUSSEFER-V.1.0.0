...
public class ChatSession {
    ...
    @Id
    @Column(name = "reference_id", nullable = false, unique = true)  // ✅ ADDED explicit @Column
    private String referenceId;   // reservationId ou voyageReservationId

    // ❌ REMOVED: referenceIdCopy was causing DuplicateMappingException
    ...
    protected void onCreate() {
        ...
        // ❌ REMOVED: referenceIdCopy = referenceId;
    }
}