package com.moussefer.notification.security;
...
/**
 * Protects /internal/* endpoints — they must be called only by other microservices
 * via the shared X-Internal-Secret header, never directly by external clients.
 */
@Component
