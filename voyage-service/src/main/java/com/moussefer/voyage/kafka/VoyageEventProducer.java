...
public class VoyageEventProducer {
    ...
    // FIX #15: Added for confirmVoyagePayment() flow (US-92)
    public void sendVoyagePaymentConfirmed(com.moussefer.voyage.entity.ReservationVoyage reservation) {
        ...
        kafkaTemplate.send("voyage.payment.confirmed", reservation.getPassengerId(), payload);
        log.info("Published voyage.payment.confirmed: reservationId={}", reservation.getId());
    }
